...
class AMSGrad_noisy:
    def __init__(self, lr=0.01, dim=2, beta1=0.9, beta2=0.999, eps=1e-8, noise_std=0.5):
        self.lr = lr
        self.beta1 = beta1
        self.beta2 = beta2
        self.eps = eps
...
class PolakRibiereCG_noisy:
    def __init__(self, dim=2, alpha_init=1.0, rho=0.5, c=1e-4, noise_std=0.5):
...
class MomentumGD_noisy:
    def __init__(self, lr=0.0001, momentum=0.9, dim=2, base_noise_std=0.5):
        self.lr = lr
